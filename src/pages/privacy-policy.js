    ...
    return (
        <Layout pageTitle="About Me">
            <Seo
                ...
                description="Complete information about how we deal with user privacy and data."
            ...
            <div className="bg-gray-700">
                <div className="xl:container mx-auto px-2 md:px-4 xl:px-20 py-12 text-center">
                    ...
                    <p className="md:mb-6 font-medium leading-6 text-gray-200 lg:max-w-3xl mx-auto">
                        Complete information about how we deal with user privacy
                        and data.
                    </p>
                ...
                <section className="text-gray-200 body-font xl:container mx-auto px-2 md:px-4 xl:px-52 bg-gray-800">
                    <div className="lg:py-12 py-6 mx-auto orb-page">
                        <p>
                            At OrbitGadget, (accessible from
                            https://orbitgadget.com), one of our main priorities
                            is the privacy of our visitors. This Privacy Policy
                            document contains types of information that are
                            collected and recorded by OrbitGadget and how we use
                            it.
                        </p>
                        <p>
                            ...
                            and/or collect in OrbitGadget. This policy is not
                        ...
                        <h2>Log Files</h2>
                        <p>
                            OrbitGadget follows a standard procedure of using
                        ...
                        <p>
                            Like any other website, OrbitGadget uses ‘cookies’.
                            These cookies are used to store information
                            including visitors’ preferences, and the pages on
                        ...
                        <p>
                            ...
                            It also uses cookies, known as DART cookies, to
                            serve ads to our site visitors based upon their
                            visit to www.website.com and other sites on the
                            internet. However, visitors may choose to decline
                            the use of DART cookies by visiting the Google ad
                        ...
                        <p>
                            ...
                            below. Each of our advertising partners has their
                            own Privacy Policy for their policies on user data.
                            For easier access, we hyperlinked to their Privacy
                        ...
                        <p>
                            ...
                            for each of the advertising partners of OrbitGadget.
                        </p>
                        <p>
                            ...
                            advertisements and links that appear on OrbitGadget,
                        ...
                        <p>
                            Note that OrbitGadget has no access to or control
                            over these cookies that are used by third-party
                            advertisers.
                        </p>
                        <h2>Third-Party Privacy Policies</h2>
                        <p>
                            OrbitGadget’s Privacy Policy does not apply to other
                            advertisers or websites. Thus, we are advising you
                        ...
                        <ul>
                            ...
                            <li>
                                Request that a business deletes any personal
                        ...
                        <p>
                            OrbitGadget does not knowingly collect any Personal
                        ...
                        <h2>Contact Us</h2>
                        <p>
                            To have a clear picture of our terms of service head
                            to this page. If you still have any queries
                            regarding the privacy policy or our terms of
                            service, kindly drop an email to us from here.
                        </p>
                    </div>
                </section>
            </div>
